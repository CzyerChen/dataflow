...
/**
 * Desciption:TaskReader的参数配置类
 *
 * @author Claire.Chen
 * @create_time 2019 -04 - 10 12:38
 */
public class MysqlReaderParameter extends PluginReaderParameter {
     ...
     * 将某些特定类型的事件过滤掉
     */
    private List<RdbmsOperationEnum> filteredEventTypes = new ArrayList<>();
    /**
    ...
    public Set<MediaSourceTypeEnum> initSupportedSourceTypes() {
        return Sets.newHashSet(MediaSourceTypeEnum.MYSQL);
    }
    ...
    public List<RdbmsOperationEnum> getFilteredEventTypes() {
        return filteredEventTypes;
    }

    public void setFilteredEventTypes(List<RdbmsOperationEnum> filteredEventTypes) {
